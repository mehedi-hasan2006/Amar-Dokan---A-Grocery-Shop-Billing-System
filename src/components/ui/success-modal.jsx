    ...
    <div className="space-y-4">
      ...
      <Modal isOpen={isSuccessOpen} onClose={() => setIsSuccessOpen(false)} size="sm">
        <div className="text-center space-y-4">
          <div
            className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-green-100 dark:bg-green-900/30">
            <svg
      ...
      <Modal
        ...
        <div className="text-center space-y-6">
          <div
            className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-blue-100 dark:bg-blue-900/30">
            <svg
          ...
          <div className="flex justify-center space-x-3">
            <Button onClick={() => setIsCompletionOpen(false)} variant="secondary">
              Later
            </Button>
            <Button onClick={() => setIsCompletionOpen(false)} variant="default">
              Get Started
            </Button>
          </div>
        </div>
      ...
      <Modal
        ...
        <div className="text-center space-y-6">
          <div className="relative">
            <div
              className="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 animate-pulse">
              <svg
            ...
            <div className="absolute -top-2 -right-2">
              <div
                className="flex items-center justify-center h-8 w-8 rounded-full bg-yellow-400 text-white text-xs font-bold">
                🎉
              </div>
            </div>
          </div>
          ...
          <div>
            <h3
              className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400">
              Achievement Unlocked!
            </h3>
