  ...
  return (<motion.div initial={{
      ...
      duration: 0.3
        ...
        <div className="relative z-10 flex items-center space-x-4">
            {showIcon && <div className={`flex-shrink-0 ${config.iconColor}`}>
                    {config.icon}
                </div>}
        ...
        {duration && <div className="absolute bottom-0 left-0 h-1 w-full bg-gray-300/50 dark:bg-gray-600/50 rounded-b-xl overflow-hidden">
                <motion.div initial={{
          width: 0
        }} animate={{
          width: '100%'
          ...
          ease: "linear"
        }} onAnimationComplete={() => onClose()} className={`h-full bg-gradient-to-r from-green-400 via-blue-400 to-sky-400 dark:from-green-500 dark:via-blue-500 dark:to-sky-500`}></motion.div>
            </div>}
    </motion.div>
  );
};
